...
export const metadata: Metadata = { title: "Admin Assignments — Legacy Command Center" };
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <h1 className="mt-2 font-display text-4xl font-semibold text-ink">
        Choose a course to author assignments<span className="text-rose-gold">.</span>
      </h1>
      <p className="mt-2 max-w-xl text-sm text-slate">
        Assignments grouped by unit — including drafts — with AI generation and a filter by type.
      </p>
        ...
        <div className="mt-8 border-t border-rose-gold/40">
          {courses.map((course) => (
            <div key={course.id} className="ledger-row">
              <Link
                href={`/admin/assignments/${course.slug}`}
